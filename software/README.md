...
+ The **FreeRTOS** directory contains the FreeRTOS source code, and contains
  its own readme file.

+ The **FreeRTOS/Demo** directory contains a demo application for every official
FreeRTOS port, and contains its own readme file.

+ The **FreeRTOS/portable** directory contains files which depend on RVCoreP.

+ The **demo** directory contains the template project for RVCoreP.
